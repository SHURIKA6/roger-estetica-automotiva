...
const NAV_CTA = 'inline-flex min-h-12 items-center gap-[11px] border border-line px-[17px] text-paper transition hover:border-red hover:bg-red hover:[transform:translateY(-2px)] lg-down:mt-4 lg-down:font-sans lg-down:text-[10px]'
...
const NAV_BASE = 'flex items-center gap-[clamp(18px,2.3vw,36px)] text-[10px] font-extrabold tracking-[.1em] text-paper-soft uppercase lg-down:fixed lg-down:inset-0 lg-down:z-[21] lg-down:h-screen lg-down:min-h-[100dvh] lg-down:flex-col lg-down:items-start lg-down:justify-center lg-down:bg-ink lg-down:font-display lg-down:leading-[.85] lg-down:tracking-[.03em]'
const NAV_SIZING = 'lg-down:gap-[23px] lg-down:px-[26px] lg-down:pt-[110px] lg-down:pb-[50px] lg-down:text-[46px] sm-down:gap-[22px] sm-down:px-5 sm-down:pt-24 sm-down:pb-10 sm-down:text-[clamp(40px,13vw,58px)]'
